...
class TinyMCEeditorMonkeypatch(models.AbstractModel):
    _name = 'tinymceeditor.monkeypatch'
    _description = 'Monkeypatches for TinyMCEEditor'
    ...
    def _register_hook(self, cr):
        ...
        return super(TinyMCEeditorMonkeypatch, self)._register_hook(cr)
