...
class eq_sale_order_template(models.Model):
    ...
    def change_template_id(self, quote_template, partner=False, fiscal_position=False, order_lines=[]):
    ...
    def onchange_document_template_id(self):
        ...
        if (selected_template):
            ...
            if (self.document_template_id):
                res = self.change_template_id(selected_template, partner_id, self.fiscal_position,
                                                         self.order_line)
