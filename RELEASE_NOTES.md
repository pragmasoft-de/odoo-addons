...
### equitania, 1.0.175
#### FIX
-changes on eq_custom_ref_view.xml

### 28.1.2016
### equitania, 1.0.174
#### FIX
-changes on eq_address_extension_view.xml
...
### equitania, 1.0.172
#### FIX
-changes on eq_report_extension_view.xml
...
product.pricelist.item,eq_pricelist_item_search and product.category object

### 22.1.2016
### equitania, 1.0.162
#### FIX
-changes for sale.order and sale.order.line object
...
### equitania, 1.0.157
#### FIX
-changes for base.config.settings object
...
### equitania, 1.0.135
#### Feature
- changes for eq_lead_referred.py and eq_lead_referred_view.xml
...
### equitania, 1.0.129
#### Feature
- changes for eq_address_extension.py and eq_address_extension_view.xml
