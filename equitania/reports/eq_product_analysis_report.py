...
class eq_product_analysis_report(report_sxw.rml_parse):
    """
        Report class for qweb report equitania_product_analysis_report that was originaly created as pentaho report
    """
    
    _name = 'equitania.eq_product_analysis_report'
    ...
    def __init__(self, cr, uid, name, context):
        ...
        super(eq_product_analysis_report, self).__init__(cr, uid, name, context=context)
    ...
    def _format_number(self, number):
        """
            Small ui helper - formates number to our standard with 2 decimal positions
        """
    ...
    def _get_records(self):
        ...
        result = []
        table = self.pool.get('eq.product.analysis.data')        
...
class report_lunchorder(osv.AbstractModel):
    _name = 'report.equitania.eq_product_analysis_report'
    _inherit = 'report.abstract_report'
    _template = 'equitania.eq_product_analysis_report'
    _wrapped_report_class = eq_product_analysis_report